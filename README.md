...
- Easy
  ...
  - Horse-Sacing Duals (In progress)
    - Done: Bash, C, C++, C#, Clojure, Dart, F#, Go
    - Remaining: Groovy, Haskell, Java, JavaScript, Lua, ObjectiveC, OCaml, Pascal, Perl, PHP, Python, Python3, Ruby, Rust, Scala, Swift3, VB.NET
