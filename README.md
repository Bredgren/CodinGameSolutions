...
- Easy
  ...
  - Horse-Sacing Duals (In progress)
    - Done: Bash, C, Go, Clojure
    - Remaining: C++, C#, Dart, F#, Groovy, Haskell, Java, JavaScript, Lua, ObjectiveC, OCaml, Pascal, Perl, PHP, Python, Python3, Ruby, Rust, Scala, Swift3, VB.NET
